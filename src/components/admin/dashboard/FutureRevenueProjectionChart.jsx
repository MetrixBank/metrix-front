...
const FutureRevenueProjectionChart = ({ data, loading }) => {
    ...
    return (
        <Card className="bg-[#1e293b]/40 border-white/10 shadow-lg">
            <CardHeader>
                <CardTitle className="text-lg text-white font-semibold">Projeção de Receita (Próx. 3 Meses)</CardTitle>
            </CardHeader>
            <CardContent>
...
export default FutureRevenueProjectionChart;