...
const SubAdminTeamProductionChart = ({ data, loading }) => {
    ...
    return (
        <Card className="bg-[#1e293b]/40 border-white/10 shadow-lg">
            <CardHeader>
                <CardTitle className="text-lg text-white font-semibold">Produção da Equipe</CardTitle>
            </CardHeader>
            <CardContent>
...
export default SubAdminTeamProductionChart;